                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p>
                        ...
                        instructor who has taught well over 300,000 students,
                        Mike unveils the secrets of developing your own custom
                        GPTs, ensuring your skills shine in the thriving digital
                        marketplace.{" "}
                      </p>
                      <p>
                                ...
                                <li className="p-4 px-3 d-flex justify-content-between">
                                  <p className="mb-0">
                                    <ImageWithBasePath
                                      ...
                                      alt="img"
                                    />
                                    Lecture1.3 How to solve the previous
                                    exercise
                                  </p>
                                  <div className="d-flex gap-xl-5 gap-3">
                                    <Link to="#" className="preview-link">
                                ...
                                <li className="p-4 px-3 d-flex justify-content-between">
                                  <p className="mb-0">
                                    <ImageWithBasePath
                                      ...
                                      alt="img"
                                    />
                                    Lecture1.5 How to use text layers
                                    effectively
                                  </p>
                                  <div className="d-flex gap-xl-5 gap-3">
                                    <Link to="#" className="preview-link">
                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <p>
                        ...
                        English, Bootstrap, Responsive Web Design, Pixel
                        Perfect, Graphic Design, Corporate, Creative, Flat,
